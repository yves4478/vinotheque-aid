...
import { mockWines, getDrinkStatus, getWineTypeLabel } from "@/data/wines";
...
const Suggestions = () => {
  const readyWines = mockWines.filter(w => getDrinkStatus(w).label === "Trinkreif");
    ...
    <AppLayout>
      <div className="mb-6 animate-fade-in">
        ...
        <p className="text-muted-foreground font-body mt-1">
          Personalisierte Empfehlungen basierend auf deinem Keller
        </p>
      </div>
