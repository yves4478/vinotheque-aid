      ...
      {mode === "single" && (
        <div className="relative">
          ...
          >
            ...
            {!value && (
              <span className="flex-1 min-w-[120px] text-sm text-muted-foreground/40">
                {country ? `Rebsorte aus ${country} wählen…` : "Rebsorte wählen…"}
              </span>
            )}
            {value && (
              <span className="flex-1 min-w-[120px] text-sm text-muted-foreground/40">
                Andere Rebsorte wählen…
              </span>
            )}
              ...
              <div className="max-h-56 overflow-y-auto overscroll-contain">
                <div className="p-2 border-b border-gray-100">
                  <input
                    ...
                    placeholder="Suchen…"
                    className="h-10 w-full rounded-lg border border-gray-200 bg-white px-3 text-sm outline-none placeholder:text-muted-foreground/40 focus:border-primary/50 focus:ring-2 focus:ring-primary/10"
                  />
                </div>
                {suggestions.length > 0 && suggestions.map((grape) => (
                    <button
                      key={grape}
                      type="button"
      ...
      {mode === "assemblage" && (
        <div className="relative">
          ...
          >
            ...
            <span className="flex-1 min-w-[120px] text-sm text-muted-foreground/40">
              {selected.size === 0 ? "Trauben für Assemblage wählen…" : "Weitere hinzufügen…"}
            </span>
